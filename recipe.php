...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
	...
	<div id="gzad_container" style="position:absolute; z-index:10000; margin: 0px; width: 100%; height:<?=(strpos($_SERVER['HTTP_REFERER'],'turkeyvolume') !== false)?'90px':'100%'?>; -webkit-transition: height 0.25s linear 0.25s, -webkit-transform 0.25s linear 0.25s; transition: height 0.25s linear 0.25s, transform 0.25s linear 0.25s;">
	...
	<div id="fb-root"></div>
		...
		js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.5&appId=1646252625586188";
		...
		<div class="container">
			...
			<div class="content">
				...
				<div id="recipe" class="col8">
					...
					<div id="sharebuttons">
						<a data-pin-do="buttonBookmark" data-pin-color="red" style="margin: 3px 10px; float: left;" href="https://www.pinterest.com/pin/create/button/"><img src="//assets.pinterest.com/images/pidgets/pinit_fg_en_rect_red_20.png" style="margin-right:10px;" /></a>
						<!-- Please call pinit.js only once per page -->
						<script async defer src="//assets.pinterest.com/js/pinit.js"></script>
						
						<div class="fb-share-button" data-href="http://www.turkeyvolumeguessingapp.com/recipe.php" data-layout="button" style=""></div>
						
						<a href="https://twitter.com/share" class="twitter-share-button" data-via="greenzeta" data-count="none">Tweet</a>
					...
					<div class="buffertop" style="">
						...
						<p id="roast" style="margin-bottom: 50px;"><img src="img/roast.jpg"/></p>

						<p>Change up your turkey with a cranberry sweet tea brine! This recipe, brought to you by <a href="http://www.greenzeta.com" target="_blank">GreenZeta</a> and <a href="http://www.turkeyvolumeguessingapp.com" target="_blank">Turkey Volume Guessing App</a>, adds an exotic sweet citrus flavor that's like nothing you've had before. The process requires a bit of planning ahead as the turkey must sit in the brine 24 hours before cooking. </p>
						
						<p>One trick I like to use: Start the turkey upside down and then flip it halfway through. It allows the juices to flow downward into the breast, preventing it from drying out, but not long enough to become soggy. It requires very little basting. The end result is a perfectly roasted turkey that's juicy throughout.</p>
						...
						<ol>
							...
							<li>Remove from heat and add tea leaves. Steep for 5 minutes.</li>
			...
			<div id="page2" class="content" style="">
				<div class="col2">&nbsp;</div>
				<div id="recipe" class="col8">
