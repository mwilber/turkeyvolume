...
class Auth_Model extends CI_Model
{
	var $table = "tblAuth";
	var $pk = "authId";
	var $ds = "authTimeStamp";  //Default sortby field 
	var $rq = "authServiceId";		//Required field (you'll need to mod the form validation if there isn't one)
	var $fields = array(
		'authService' => array('label'=>'Service Id','type'=>'varchar','constraint'=>50),
		'authServiceId' => array('label'=>'Service Id','type'=>'varchar','constraint'=>50),
		'authToken' => array('label'=>'Token','type'=>'varchar','constraint'=>200),
		'authSecret' => array('label'=>'Secret','type'=>'varchar','constraint'=>200),
		'profileId' => array('label'=>'Profile','type'=>'int','constraint'=>11),
		);
	...
	function GetClean($options = array()){
