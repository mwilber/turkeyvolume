...
{
	var $table = "tblAccount";
	var $pk = "accountId";
	var $ds = "accountTimeStamp";  //Default sortby field 
	var $rq = "accountExtId";		//Required field (you'll need to mod the form validation if there isn't one)
	var $fields = array(
		 'accountExtId' => array('label'=>'External Id','type'=>'varchar','constraint'=>50),
		 'accountType' => array('label'=>'Type','type'=>'varchar','constraint'=>10),
