...
class Cloud_Model extends CI_Model
{
	var $table = "tblCloud";
	var $pk = "cloudId";
	var $ds = "cloudTimeStamp";  //Default sortby field 
	var $rq = "cloudName";		//Required field (you'll need to mod the form validation if there isn't one)
	var $fields = array(
		 'cloudName' => array('label'=>'Name','type'=>'varchar','constraint'=>50),
		 'cloudImage' => array('label'=>'Image','type'=>'varchar','constraint'=>50),
		 'cloudDataStart' => array('label'=>'Start','type'=>'text'),
		 'cloudDataFinish' => array('label'=>'Finish','type'=>'text'),
		 'profileId' => array('label'=>'Profile','type'=>'int'),
		 'cloudComment' => array('label'=>'Comment','type'=>'varchar','constraint'=>200),
		);
