...
$config['opauth_config'] = array(
    'path' => '/cloudartist/public/reactor/oauth/login/', //example: /ci_opauth/auth/login/
	'callback_url' => '/cloudartist/public/reactor/oauth/authenticate/', //example: /ci_opauth/auth/authenticate/
    ...
    'Strategy' => array( //comment those you don't use
        ...
        'LinkedIn' => array(
			'api_key' => '77l72fifymgsqc',
			'secret_key' => 'xL6GFlbwamIdIvtT'
		)
        //'Foursquare' => array(
